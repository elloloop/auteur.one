...
export function Canvas({
    ...
    return (
        <div className="w-full h-full relative flex flex-col items-center justify-center p-4 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-slate-900 to-black">
            <div className="relative border border-slate-800 shadow-2xl bg-black w-full h-full" style={{ maxWidth: '100%', maxHeight: '100%' }}>
                <canvas
                    ref={canvasRef}
                    width={1920}
                    height={1080}
